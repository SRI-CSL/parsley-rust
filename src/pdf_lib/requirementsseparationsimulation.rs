...
use crate::pdf_lib::requirementshandler::requirementshandler_type;
    ...
    let choices_s = ChoicesPred(
        ...
        vec![ 
         PDFObjT::Name(NameT::new(Vec::from("Transitions"))),
           ],
     );
pub fn requirementsseparationsimulation_type(tctx: &mut TypeCheckContext) -> Rc<TypeCheck> {
    ...
    TypeCheck::new(
    tctx,
    "requirementsseparationsimulation",
