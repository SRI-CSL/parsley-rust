...
pub fn halftonetype10_type(tctx: &mut TypeCheckContext) -> Rc<TypeCheck> {
    ...
    let xsquare_field = DictEntry { 
       key: Vec::from("Xsquare"), 
       opt: DictKeySpec::Required,
    }; 
    let ysquare_field = DictEntry { 
       key: Vec::from("Ysquare"), 
       opt: DictKeySpec::Required,
    }; 
