...
use std::rc::Rc;
pub fn richmediainstances_type<'a>(tctx: &'a mut TypeCheckContext) -> Rc<TypeCheck> {
    ...
    let choices_type = ChoicePred(
        ...
        vec![PDFObjT::Name(NameT::new(Vec::from("RichMediaInstance")))],
    );
    ...
    TypeCheck::new(
        tctx,
        "richmediainstances",
        Rc::new(PDFType::Dict(vec![type_field, subtype_field, asset_field])),
    )
}
