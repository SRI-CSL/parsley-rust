...
pub fn shadingtype5_type(tctx: &mut TypeCheckContext) -> Rc<TypeCheck> {
    ...
    let verticesperrow_field = DictEntry { 
       key: Vec::from("VerticesPerRow"), 
       chk: choices_verticesperrow(tctx),
       opt: DictKeySpec::Required,
    }; 
