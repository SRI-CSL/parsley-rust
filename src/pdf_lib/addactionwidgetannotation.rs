...
use std::rc::Rc;
pub fn addactionwidgetannotation_type<'a>(tctx: &'a mut TypeCheckContext) -> Rc<TypeCheck> {
    ...
    let assignment_199 = actionrichmediaexecute_type(tctx);
    let assignment_159 = actionrichmediaexecute_type(tctx);
    let assignment_119 = actionrichmediaexecute_type(tctx);
    let assignment_179 = actionrichmediaexecute_type(tctx);
    ...
    let assignment_198 = actionecmascript_type(tctx);
    ...
    let assignment_178 = actionecmascript_type(tctx);
    ...
    let assignment_177 = actiongoto3dview_type(tctx);
    ...
    let assignment_197 = actiongoto3dview_type(tctx);
    ...
    let assignment_176 = actiontransition_type(tctx);
    ...
    let assignment_196 = actiontransition_type(tctx);
    ...
    let assignment_195 = actionrendition_type(tctx);
    let assignment_75 = actionrendition_type(tctx);
    let assignment_175 = actionrendition_type(tctx);
    ...
    let assignment_174 = actionsetocgstate_type(tctx);
    ...
    let assignment_194 = actionsetocgstate_type(tctx);
    ...
    let assignment_173 = actionimportdata_type(tctx);
    let assignment_193 = actionimportdata_type(tctx);
    ...
    let assignment_192 = actionresetform_type(tctx);
    ...
    let assignment_172 = actionresetform_type(tctx);
    ...
    let assignment_191 = actionsubmitform_type(tctx);
    ...
    let assignment_171 = actionsubmitform_type(tctx);
    ...
    let assignment_170 = actionnamed_type(tctx);
    let assignment_70 = actionnamed_type(tctx);
    let assignment_190 = actionnamed_type(tctx);
    ...
    let assignment_169 = actionhide_type(tctx);
    let assignment_189 = actionhide_type(tctx);
    let assignment_109 = actionhide_type(tctx);
    let assignment_89 = actionhide_type(tctx);
    let assignment_29 = actionhide_type(tctx);
    let assignment_168 = actionmovie_type(tctx);
    ...
    let assignment_188 = actionmovie_type(tctx);
    let assignment_88 = actionmovie_type(tctx);
    let assignment_128 = actionmovie_type(tctx);
    let assignment_187 = actionsound_type(tctx);
    let assignment_107 = actionsound_type(tctx);
    let assignment_167 = actionsound_type(tctx);
    ...
    let assignment_166 = actionuri_type(tctx);
    let assignment_186 = actionuri_type(tctx);
    ...
    let assignment_165 = actionthread_type(tctx);
    ...
    let assignment_185 = actionthread_type(tctx);
    ...
    let assignment_184 = actionlaunch_type(tctx);
    let assignment_24 = actionlaunch_type(tctx);
    let assignment_144 = actionlaunch_type(tctx);
    let assignment_164 = actionlaunch_type(tctx);
    ...
    let assignment_183 = actiongotodp_type(tctx);
    let assignment_163 = actiongotodp_type(tctx);
    ...
    let assignment_182 = actiongotoe_type(tctx);
    ...
    let assignment_162 = actiongotoe_type(tctx);
    let assignment_21 = actiongotor_type(tctx);
    let assignment_161 = actiongotor_type(tctx);
    let assignment_121 = actiongotor_type(tctx);
    let assignment_81 = actiongotor_type(tctx);
    let assignment_181 = actiongotor_type(tctx);
    ...
    let assignment_180 = actiongoto_type(tctx);
    ...
    let assignment_160 = actiongoto_type(tctx);
    ...
    let fo_field = DictEntry {
        key: Vec::from("Fo"),
        chk: dis_4,
        opt: DictKeySpec::Optional,
    };
    let bl_field = DictEntry {
        key: Vec::from("Bl"),
        chk: dis_5,
        opt: DictKeySpec::Optional,
    };
    ...
    TypeCheck::new(
        ...
        Rc::new(PDFType::Dict(vec![
            e_field, x_field, d_field, u_field, fo_field, bl_field, po_field, pc_field, pv_field,
            pi_field,
        ])),
    )
}
