...
use crate::pdf_lib::requirementshandler::requirementshandler_type;
    ...
    let choices_s = ChoicesPred(
        ...
        vec![ 
         PDFObjT::Name(NameT::new(Vec::from("CollectionEditing"))),
           ],
     );
pub fn requirementscollectionediting_type(tctx: &mut TypeCheckContext) -> Rc<TypeCheck> {
