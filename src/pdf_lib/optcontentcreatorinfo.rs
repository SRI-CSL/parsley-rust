...
use std::rc::Rc;
pub fn optcontentcreatorinfo_type<'a>(tctx: &'a mut TypeCheckContext) -> Rc<TypeCheck> {
    ...
    let choices_subtype = ChoicePred(
        ...
        vec![
            ...
            PDFObjT::Name(NameT::new(Vec::from("Technical"))),
    ...
    TypeCheck::new(
        ...
        Rc::new(PDFType::Dict(vec![creator_field, subtype_field])),
    )
}
