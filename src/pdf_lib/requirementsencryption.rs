...
use crate::pdf_lib::encryptionstandard::encryptionstandard_type;
use crate::pdf_lib::encryptionpublickey::encryptionpublickey_type;
    ...
    let choices_s = ChoicesPred(
        ...
        vec![ 
         PDFObjT::Name(NameT::new(Vec::from("Encryption"))),
           ],
     );
pub fn requirementsencryption_type(tctx: &mut TypeCheckContext) -> Rc<TypeCheck> {
    ...
    let encrypt_field = DictEntry { 
       key: Vec::from("Encrypt"), 
       chk: Rc::new(PDFType::Disjunct(vec![
         [_type,
         e_type,
         n_type,
