...
use std::rc::Rc;
pub fn actionecmascript_type<'a>(tctx: &'a mut TypeCheckContext) -> Rc<TypeCheck> {
    ...
    let dis_1 = TypeCheck::new(tctx, "js", Rc::new(PDFType::Disjunct(vec![assignment_21])));
    ...
    let choices_s = ChoicePred(
        ...
        vec![PDFObjT::Name(NameT::new(Vec::from("JavaScript")))],
    );
    ...
    TypeCheck::new(
        ...
        Rc::new(PDFType::Dict(vec![
            type_field, s_field, next_field, js_field,
        ])),
    )
}
