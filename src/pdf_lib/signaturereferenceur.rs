...
use crate::pdf_lib::urtransformparameters::urtransformparameters_type;
...
use crate::pdf_lib::stream::stream_type;
    ...
    let choices_transformmethod = ChoicesPred(
        ...
        vec![ 
         PDFObjT::Name(NameT::new(Vec::from("UR"))),
           ],
     );
...
pub fn signaturereferenceur_type(tctx: &mut TypeCheckContext) -> Rc<TypeCheck> {
