...
use crate::pdf_lib::optcontentusage::optcontentusage_type;
...
use std::rc::Rc;
pub fn optcontentgroup_type<'a>(tctx: &'a mut TypeCheckContext) -> Rc<TypeCheck> {
    let assignment_2 = optcontentusage_type(tctx);
    let assignment_1 = arrayofnamesgeneral_type(tctx);
    ...
    let choices_type = ChoicePred(
        ...
        vec![PDFObjT::Name(NameT::new(Vec::from("OCG")))],
    );
