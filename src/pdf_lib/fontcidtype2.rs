...
use crate::pdf_lib::fontdescriptorcidtype2::fontdescriptorcidtype2_type;
...
use crate::pdf_lib::stream::stream_type;
    ...
    let choices_subtype = ChoicesPred(
        ...
        vec![ 
         PDFObjT::Name(NameT::new(Vec::from("CIDFontType2"))),
           ],
     );
pub fn fontcidtype2_type(tctx: &mut TypeCheckContext) -> Rc<TypeCheck> {
