...
use std::rc::Rc;
pub fn renditionselector_type<'a>(tctx: &'a mut TypeCheckContext) -> Rc<TypeCheck> {
    let assignment_4 = renditionmedia_type(tctx);
    let assignment_3 = renditionselector_type(tctx);
    ...
    let choices_s = ChoicePred(
        ...
        vec![PDFObjT::Name(NameT::new(Vec::from("SR")))],
    );
    ...
    TypeCheck::new(
        ...
        Rc::new(PDFType::Dict(vec![
            type_field, s_field, n_field, mh_field, be_field, r_field,
        ])),
    )
}
