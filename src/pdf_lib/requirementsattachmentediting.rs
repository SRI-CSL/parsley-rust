...
use crate::pdf_lib::requirementshandler::requirementshandler_type;
    ...
    let choices_s = ChoicesPred(
        ...
        vec![ 
         PDFObjT::Name(NameT::new(Vec::from("AttachmentEditing"))),
           ],
     );
pub fn requirementsattachmentediting_type(tctx: &mut TypeCheckContext) -> Rc<TypeCheck> {
