...
use std::rc::Rc;
pub fn threedview_type<'a>(tctx: &'a mut TypeCheckContext) -> Rc<TypeCheck> {
    ...
    let assignment_1 = TypeCheck::new(tctx, "in", Rc::new(PDFType::PrimType(PDFPrimType::String)));
