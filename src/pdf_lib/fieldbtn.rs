...
use std::rc::Rc;
pub fn fieldbtn_type<'a>(tctx: &'a mut TypeCheckContext) -> Rc<TypeCheck> {
    let assignment_16 = TypeCheck::new(tctx, "dv", Rc::new(PDFType::PrimType(PDFPrimType::Name)));
    let assignment_15 = TypeCheck::new(tctx, "v", Rc::new(PDFType::PrimType(PDFPrimType::Name)));
    let assignment_14 = arrayofstringstext_type(tctx);
    let assignment_13 = stream_type(tctx);
    let assignment_12 = TypeCheck::new(tctx, "ds", Rc::new(PDFType::PrimType(PDFPrimType::String)));
    let assignment_11 = TypeCheck::new(tctx, "da", Rc::new(PDFType::PrimType(PDFPrimType::String)));
    ...
    let dis_4 = TypeCheck::new(tctx, "opt", Rc::new(PDFType::Disjunct(vec![assignment_14])));
    let dis_3 = TypeCheck::new(tctx, "rv", Rc::new(PDFType::Disjunct(vec![assignment_13])));
    ...
    let choices_ft = ChoicePred(
        ...
        vec![PDFObjT::Name(NameT::new(Vec::from("Btn")))],
    );
