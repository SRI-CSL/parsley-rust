...
use crate::pdf_lib::annotprojection::annotprojection_type;
    ...
    let choices_subtype = ChoicesPred(
        ...
        vec![ 
         PDFObjT::Name(NameT::new(Vec::from("RD3"))),
           ],
     );
pub fn 3dmeasurerd3_type(tctx: &mut TypeCheckContext) -> Rc<TypeCheck> {
