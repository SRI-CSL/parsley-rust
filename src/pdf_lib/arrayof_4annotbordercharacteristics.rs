...
use crate::pdf_lib::arrayof_2dashnumbers::arrayof_2dashnumbers_type;
...
use std::rc::Rc;
pub fn arrayof_4annotbordercharacteristics_type<'a>(
    tctx: &'a mut TypeCheckContext,
) -> Rc<TypeCheck> {
    let assignment_3 = arrayof_2dashnumbers_type(tctx);
    ...
    let dis_0 = TypeCheck::new(tctx, "3", Rc::new(PDFType::Disjunct(vec![assignment_3])));
