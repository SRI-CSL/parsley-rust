...
use std::rc::Rc;
pub fn microsoftwindowslaunchparam_type<'a>(tctx: &'a mut TypeCheckContext) -> Rc<TypeCheck> {
    ...
    let assignment_0 = TypeCheck::new(tctx, "f", Rc::new(PDFType::PrimType(PDFPrimType::String)));
    ...
    TypeCheck::new(
        ...
        Rc::new(PDFType::Dict(vec![f_field, d_field, o_field, p_field])),
    )
}
