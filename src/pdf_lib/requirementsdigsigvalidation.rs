...
use crate::pdf_lib::doctimestamp::doctimestamp_type;
    ...
    let choices_s = ChoicesPred(
        ...
        vec![ 
         PDFObjT::Name(NameT::new(Vec::from("DigSigValidation"))),
           ],
     );
pub fn requirementsdigsigvalidation_type(tctx: &mut TypeCheckContext) -> Rc<TypeCheck> {
