...
use crate::pdf_lib::fontfiletype1::fontfiletype1_type;
use crate::pdf_lib::fontfile3type1::fontfile3type1_type;
...
pub fn fontdescriptortype1_type(tctx: &mut TypeCheckContext) -> Rc<TypeCheck> {
    ...
    let fontfile3_field = DictEntry { 
       key: Vec::from("FontFile3"), 
       chk: Rc::new(PDFType::Disjunct(vec![
         [_type,
         f_type,
         o_type,
