...
use std::rc::Rc;
pub fn arrayofopi13color_type<'a>(tctx: &'a mut TypeCheckContext) -> Rc<TypeCheck> {
    let assignment_4 = TypeCheck::new(tctx, "4", Rc::new(PDFType::PrimType(PDFPrimType::String)));
