...
use crate::pdf_lib::fontdescriptortype1::fontdescriptortype1_type;
...
use crate::pdf_lib::stream::stream_type;
    ...
    let choices_subtype = ChoicesPred(
        ...
        vec![ 
         PDFObjT::Name(NameT::new(Vec::from("MMType1"))),
           ],
     );
pub fn fontmultiplemaster_type(tctx: &mut TypeCheckContext) -> Rc<TypeCheck> {
