...
use crate::pdf_lib::gamma::gamma_type;
...
use std::rc::Rc;
pub fn calrgbdict_type<'a>(tctx: &'a mut TypeCheckContext) -> Rc<TypeCheck> {
    let assignment_3 = matrix_type(tctx);
    let assignment_2 = gamma_type(tctx);
